...
console.log(cutInLine([1,2,3,4], 8));
...
console.log(removeThings(["a", 1, 4, "a"], "a"))
...
function getPropertyValue(obj, objName){
...
console.log(getPropertyValue(object, "car"));
...
console.log(clockIn("keith", "sales"));


// #14 Create a function called spiderTest that takes in an object that is an actor, it looks to see if the actor's name is Andrew Garfield and changes the actor object to have a property called spiderRating with a value of 10.
